...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_EVT_RX_COUNT, 11);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_RX_SIZE, 512);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RING_BUFFER_LARGE, 1);
